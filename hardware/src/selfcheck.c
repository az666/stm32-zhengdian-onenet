...
CHECK_INFO checkInfo = {DEV_ERR, DEV_ERR, DEV_ERR, DEV_ERR};
...
void Check_PowerOn(void)
{
	...
	if(ADXL362_Init())
	{
		UsartPrintf(USART_DEBUG, "ADXL362 :Ok\r\n");
		checkInfo.ADXL362_OK = DEV_OK;
	}
	else
		UsartPrintf(USART_DEBUG, "ADXL362 :Error\r\n");
	DelayXms(1);
